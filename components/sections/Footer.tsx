    ...
    >
      <div className="flex w-full max-w-[1372px] flex-col items-start gap-[40px] px-6 lg:px-0">
        ...
        <div className="flex w-full flex-col items-start justify-center gap-[20px] lg:flex-row">
          ...
          <div className="footer-reveal flex h-[172px] w-full items-start lg:w-[477px]">
            {/* The play button used to sit on a plain <button> with no handler:
                a control that looks interactive and does nothing. It only
                appears now when there is actually a film to play. */}
            {siteConfig.showreelUrl ? (
              <a
                href={siteConfig.showreelUrl}
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Play the Project Help showreel"
                className="group relative flex h-full w-full items-start justify-center overflow-clip"
              >
                <Image
                  src="/images/footer-video-thumb.webp"
                  alt="Project Help studio showreel"
                  fill
                  sizes="(max-width: 1023px) 100vw, 477px"
              ...
              <div className="relative h-full w-full overflow-clip">
                <Image
                  src="/images/footer-video-thumb.webp"
                  alt="The Project Help studio in Dhaka"
                  fill
                  sizes="(max-width: 1023px) 100vw, 477px"
                  className="object-cover"
                />
